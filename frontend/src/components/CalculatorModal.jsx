    ...
    <div className="fixed inset-0 z-[60] flex items-end md:items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <button onClick={onClose} className="w-10 h-10 -m-1.5 flex items-center justify-center rounded-lg text-text-3 hover:text-text-1 hover:bg-white/5 transition">
